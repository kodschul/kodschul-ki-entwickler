...
```
Vergleiche die aktuelle Implementierung in app.py und index.html
...
- Wo weicht Claude von der Spec ab?
...
- [ ] Tests für alle Akzeptanzkriterien geschrieben
- [ ] Spec mit Implementierung verglichen
