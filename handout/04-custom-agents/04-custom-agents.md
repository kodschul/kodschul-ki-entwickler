...
**Block:** 10:45 – 12:15 Uhr (zusammen mit Commands & Hooks)
...
> Ein Agent ist ein **spezialisierter Claude-Prozess** mit eigenem System-Prompt und definierten Tool-Rechten.  
...
| ----------------------------------------------- | ------------------------------------------------------ |
| Spezialisierte Aufgabe mit klarem Scope         | Einfache Aufgabe → Command reicht                      |
...
| Parallele Sub-Aufgaben                          | Zu viele Agents → Übersicht verloren                   |
...
|            | Command             | Skill             | Agent                     |
| ---------- | ------------------- | ----------------- | ------------------------- |
| **Aufruf** | `/name`             | Automatisch       | Per Beschreibung          |
